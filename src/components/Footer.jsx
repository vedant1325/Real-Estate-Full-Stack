...
<div className='w-full md:w-1/5 mb-8 md:mb-0'>
    ...
    <ul className='text-gray-300 flex flex-col gap-2'>
        <a className='hover:text-yellow-500' href="#Header">Home</a>
        <a className='hover:text-yellow-500' href="#About">About us</a>
        <a className='hover:text-yellow-500' href="#Contact">Contact us</a>
        <a className='hover:text-yellow-500' href="#">Privacy Policy</a>
    </ul>
</div>
